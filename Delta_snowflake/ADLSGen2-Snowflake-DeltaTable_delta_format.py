...
# MAGIC %sql
# MAGIC drop table snow_test.DF_customer
...
df.write.mode("overwrite").format("delta").saveAsTable("snow_test.DF_customer", path=tablePath)

# COMMAND ----------

# MAGIC %sql
# MAGIC select *from snow_test.DF_customer where state="VIC"
